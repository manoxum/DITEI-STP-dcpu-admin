  ...
  return (
    <div className={cn("min-h-screen font-sans transition-colors duration-300")}>
      <div className="flex bg-slate-200 dark:bg-slate-950 text-slate-800 dark:text-slate-100 min-h-screen">
        ...
        >
          {/* Header */}
          <header className="h-24 bg-slate-200/90 dark:bg-slate-950/70 backdrop-blur-2xl border-b border-slate-300/60 dark:border-slate-800/50 flex items-center justify-between px-10 sticky top-0 z-40 transition-colors duration-500">
